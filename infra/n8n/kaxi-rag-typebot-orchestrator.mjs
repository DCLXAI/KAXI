...
const runtimeWebhook = trigger({
  ...
  config: {
    ...
    parameters: {
      ...
      options: { allowedOrigins: "https://kaxi.vercel.app,https://karxy.com", ignoreBots: false },
    },
  },
...
const verifyRuntime = node({
  ...
  config: {
    ...
    parameters: {
      method: "POST",
      url: "https://karxy.com/api/internal/n8n/verify",
      authentication: "none",
      sendBody: true,
      contentType: "json",
      specifyBody: "json",
...
const runRagCore = node({
  ...
  config: {
    ...
    parameters: {
      method: "POST",
      url: "https://karxy.com/api/internal/n8n/rag-runtime",
      authentication: "none",
      sendBody: true,
      contentType: "json",
      specifyBody: "json",
...
const runIngestionCore = node({
  ...
  config: {
    ...
    parameters: {
      method: "POST",
      url: "https://karxy.com/api/internal/n8n/rag-ingestion",
      authentication: "none",
      sendBody: true,
      contentType: "json",
      specifyBody: "json",
...
const runHandoffCore = node({
  ...
  config: {
    ...
    parameters: {
      method: "POST",
      url: "https://karxy.com/api/internal/n8n/handoff-update",
      authentication: "none",
      sendBody: true,
      contentType: "json",
      specifyBody: "json",

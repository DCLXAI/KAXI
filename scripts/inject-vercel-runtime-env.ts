...
const DEFAULT_RUNTIME_ENV_KEYS = [
  ...
  "ATTACHMENT_MALWARE_SCAN_MODE",
  "ATTACHMENT_MALWARE_SCAN_REQUIRED",
  "ATTACHMENT_MALWARE_SCAN_URL",
  ...
  "KNOWLEDGE_MONITOR_CRON_SOURCE_IDS",
  ...
  "SUPABASE_CHAT_ATTACHMENTS_BUCKET",
  "SECURITY_CREDENTIALS_ROTATED_AT",
  "SECURITY_CREDENTIAL_ROTATION_DAYS",
  "RESEND_API_KEY",
  "TYPEBOT_API_BASE_URL",
  "TYPEBOT_API_TOKEN",
  "TYPEBOT_BOT_ID",

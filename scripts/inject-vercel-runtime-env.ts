...
const DEFAULT_RUNTIME_ENV_KEYS = [
  ...
  "AI_AGENT_ALLOW_TOOL_FALLBACK",
  "AI_AGENT_LEDGER_ENABLED",
  "AI_AGENT_LOGGING_ENABLED",
  "AI_AGENT_MAX_CHARS",
  "AI_AGENT_REQUIRE_LLM",
  "AI_CONSULT_BACKEND",
  "AI_CONSULT_ALLOW_OFFICIAL_SUMMARY_FALLBACK",
  "AI_CONSULT_CODEX_CONTEXT_CHARS",
  "AI_CONSULT_CODEX_DOC_CHARS",
  "AI_CONSULT_CODEX_MAX_DOCS",
  "AI_CONSULT_DAILY_QUOTA",
  "AI_CONSULT_MAX_CHARS",
  "AI_CONSULT_RATE_LIMIT",
  "AI_CONSULT_REQUIRE_LLM",
  "AI_CONSULT_REMOTE_BRIDGE_TIMEOUT_MS",
  "AI_REQUIRE_LLM",
  "AI_AGENT_RATE_LIMIT",

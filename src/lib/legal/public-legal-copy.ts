...
const shared = {
  ko: {
    ...
    versionLabel: "게시 버전: 2026-07-10.v1 · 최종 검토: 2026-07-10",
    ...
    privacySections: [
      ...
      { title: "2. 처리 항목과 목적", bullets: ["AI 대화: 질문, 언어, 생성 답변, 검색 출처 및 품질 정보", "상담 전환: 사용자가 동의 후 입력한 이름, 연락처, 상담 메모와 Typebot 동의 증거", "첨부파일: 파일명, 형식, 크기, 보안 검사 상태, OCR 결과", "운영 보안: 요청 시각, 제한된 접속·오류·관리자 감사 기록"] },
      { title: "3. 보유 기간", bullets: ["대화 세션과 상담 동의 증거: 마지막 이용 기준 최대 90일", "챗봇 첨부파일: 최대 30일", "진단 리드: 최대 365일", "파트너 요청: 최대 180일", "법령상 보존 의무 또는 분쟁 처리가 필요한 경우에는 해당 기간 동안 분리 보관할 수 있습니다."] },
  ...
  en: {
    ...
    versionLabel: "Published version: 2026-07-10.v1 · Last reviewed: 2026-07-10",
    ...
    privacySections: [
      ...
      { title: "2. Data and purposes", bullets: ["AI chat: question, language, generated answer, retrieved sources, and quality metadata", "Human handoff: name, contact, note, and versioned Typebot consent receipt after explicit consent", "Attachments: filename, type, size, security status, and OCR result", "Operations: limited request, error, security, and administrator audit records"] },
      { title: "3. Retention", bullets: ["Chat sessions and handoff consent receipts: up to 90 days from recent use", "Chat attachments: up to 30 days", "Diagnosis leads: up to 365 days", "Partner requests: up to 180 days", "Records may be segregated for a legally required period or an active dispute."] },
...
const localized: Record<"vi" | "mn", Pick<LegalPageCopy, keyof LegalPageCopy>> = {
  vi: {
    ...
    versionLabel: "Phiên bản công bố: 2026-07-10.v1 · Rà soát: 2026-07-10",
    ...
    privacySections: [
      ...
      { title: "2. Dữ liệu và mục đích", bullets: ["Trò chuyện AI: câu hỏi, ngôn ngữ, câu trả lời, nguồn truy xuất và dữ liệu chất lượng", "Chuyển tiếp tư vấn: tên, liên hệ, ghi chú và bằng chứng đồng ý Typebot có phiên bản", "Tệp đính kèm: tên, loại, dung lượng, trạng thái kiểm tra bảo mật và kết quả OCR", "Vận hành: bản ghi giới hạn về yêu cầu, lỗi, bảo mật và thao tác quản trị"] },
      { title: "3. Thời hạn lưu giữ", bullets: ["Phiên trò chuyện và bằng chứng đồng ý: tối đa 90 ngày từ lần sử dụng gần nhất", "Tệp đính kèm: tối đa 30 ngày", "Thông tin chẩn đoán: tối đa 365 ngày", "Yêu cầu đối tác: tối đa 180 ngày", "Dữ liệu có thể được tách riêng trong thời hạn pháp luật yêu cầu hoặc khi có tranh chấp."] },
  ...
  mn: {
    ...
    versionLabel: "Нийтэлсэн хувилбар: 2026-07-10.v1 · Хянасан: 2026-07-10",
    ...
    privacySections: [
      ...
      { title: "2. Мэдээлэл ба зорилго", bullets: ["AI чат: асуулт, хэл, үүсгэсэн хариулт, хайлтын эх сурвалж, чанарын мэдээлэл", "Зөвлөхөд шилжүүлэх: тодорхой зөвшөөрлийн дараах нэр, холбоо барих мэдээлэл, тэмдэглэл, Typebot зөвшөөрлийн баримт", "Хавсралт: файлын нэр, төрөл, хэмжээ, аюулгүй байдлын төлөв, OCR үр дүн", "Үйл ажиллагаа: хязгаарлагдмал хүсэлт, алдаа, аюулгүй байдал, админы аудитын бичлэг"] },
      { title: "3. Хадгалах хугацаа", bullets: ["Чат ба зөвшөөрлийн баримт: сүүлийн ашиглалтаас 90 хүртэл хоног", "Чатын хавсралт: 30 хүртэл хоног", "Оношилгооны хүсэлт: 365 хүртэл хоног", "Түншийн хүсэлт: 180 хүртэл хоног", "Хуулийн үүрэг эсвэл маргааны үед мэдээллийг шаардлагатай хугацаанд тусгаарлан хадгалж болно."] },

...
const shared = {
  ko: {
    ...
    privacySummary: "KARXY가 챗봇, 상담 전환, 첨부파일을 운영하며 처리하는 정보를 안내합니다.",
    termsTitle: "서비스 이용 안내",
    termsSummary: "KARXY의 AI 유학 준비 안내와 상담 연결 서비스를 이용할 때 적용되는 기준입니다.",
    ...
    termsLink: "서비스 이용 안내",
    privacySections: [
      { title: "1. 처리 주체와 문의 창구", paragraphs: ["처리 주체는 KARXY입니다. 개인정보 관련 요청은 이 페이지 하단의 온라인 권리 요청 양식으로 접수합니다."] },
      ...
      { title: "4. 외부 서비스와 국외 처리", paragraphs: ["KARXY는 Vercel(웹 호스팅), Supabase(데이터베이스·파일 저장), Typebot(대화 화면), n8n(워크플로우), Moonshot AI의 Kimi(답변·OCR)를 사용합니다. 서비스 요청은 공급자 인프라에서 국외 처리될 수 있습니다. 실제 법인, 국가, 재위탁 및 보유기간 표기는 계약 확인과 전문 검토 후 갱신합니다."] },
    ...
    termsSections: [
      { title: "1. 서비스 범위", paragraphs: ["KARXY는 한국 유학 준비를 위한 학교·비용·서류 정보, 공식 출처 기반 AI 안내, 상담원 또는 독립 파트너 연결을 제공합니다."] },
      ...
      { title: "3. 상담과 파트너", paragraphs: ["KARXY 자체는 변호사, 행정사, 학교 또는 정부기관이 아닙니다. 개별 사건의 서류 작성·제출 대행이나 유료 전문 업무는 별도의 자격 있는 파트너 계약과 비용 안내가 필요합니다."] },
  ...
  en: {
    ...
    privacySummary: "How KARXY handles information for chat, human handoff, and attachments.",
    termsTitle: "Terms of Service",
    termsSummary: "Rules for using KARXY's AI study-preparation guidance and consultation routing.",
    ...
    privacySections: [
      { title: "1. Controller and request channel", paragraphs: ["KARXY is the controller. Privacy requests are accepted through the online form at the bottom of this page."] },
      ...
      { title: "4. Vendors and overseas processing", paragraphs: ["KARXY uses Vercel for hosting, Supabase for database and storage, Typebot for chat UI, n8n for workflow orchestration, and Moonshot AI's Kimi for responses and OCR. Requests may be processed outside Korea on vendor infrastructure. Legal entities, countries, subprocessors, and provider retention details will be updated after contract confirmation and professional review."] },
      ...
      { title: "6. Security and deletion", paragraphs: ["KARXY uses encrypted transport, encryption or masking for sensitive chat and contact fields, role-based administrator access, and audit records. Database records and stored files are deleted after retention or a verified deletion request."] },
    ...
    termsSections: [
      { title: "1. Service scope", paragraphs: ["KARXY provides Korean study-preparation information, school and cost tools, official-source AI guidance, and routing to a human operator or independent partner."] },
      ...
      { title: "3. Consultation and partners", paragraphs: ["KARXY is not a law firm, administrative-scrivener office, school, or government body. Case-specific drafting, filing, representation, and paid professional work require a separate engagement and fee notice with a qualified partner."] },
      ...
      { title: "6. Attachments", paragraphs: ["Attachments may be held temporarily for security checks and OCR. KARXY is not an archival repository; keep your own originals."] },
      { title: "7. Beta operation and changes", paragraphs: ["The service is in beta. KARXY may modify or suspend features for safety, legal, vendor, or operational reasons and will notify material changes affecting user rights where required."] },
...
const localized: Record<"vi" | "mn", Pick<LegalPageCopy, keyof LegalPageCopy>> = {
  vi: {
    ...
    privacySummary: "Cách KARXY xử lý dữ liệu cho trò chuyện, chuyển tiếp tư vấn và tệp đính kèm.",
    termsTitle: "Điều khoản sử dụng",
    termsSummary: "Các quy tắc khi sử dụng hướng dẫn AI và dịch vụ kết nối tư vấn của KARXY.",
    ...
    home: "Trang chủ KARXY",
    privacyLink: "Quyền riêng tư",
    termsLink: "Điều khoản",
    privacySections: [
      { title: "1. Đơn vị xử lý và kênh yêu cầu", paragraphs: ["KARXY là đơn vị xử lý dữ liệu. Yêu cầu về quyền riêng tư được tiếp nhận qua biểu mẫu trực tuyến ở cuối trang này."] },
      ...
      { title: "4. Nhà cung cấp và xử lý ở nước ngoài", paragraphs: ["KARXY dùng Vercel để lưu trữ web, Supabase cho cơ sở dữ liệu và tệp, Typebot cho giao diện trò chuyện, n8n cho quy trình, và Kimi của Moonshot AI cho trả lời và OCR. Yêu cầu có thể được xử lý ngoài Hàn Quốc. Thông tin pháp nhân, quốc gia, nhà thầu phụ và thời hạn của nhà cung cấp sẽ được cập nhật sau khi xác nhận hợp đồng và rà soát chuyên môn."] },
      ...
      { title: "6. Bảo mật và xóa", paragraphs: ["KARXY dùng kết nối mã hóa, mã hóa hoặc che dữ liệu nhạy cảm, phân quyền quản trị và nhật ký kiểm toán. Bản ghi và tệp được xóa khi hết hạn hoặc sau yêu cầu xóa đã xác minh."] },
    ...
    termsSections: [
      { title: "1. Phạm vi dịch vụ", paragraphs: ["KARXY cung cấp thông tin chuẩn bị du học Hàn Quốc, công cụ trường học và chi phí, hướng dẫn AI dựa trên nguồn chính thức, và kết nối với nhân viên hoặc đối tác độc lập."] },
      ...
      { title: "3. Tư vấn và đối tác", paragraphs: ["KARXY không phải công ty luật, văn phòng hành chính, trường học hoặc cơ quan nhà nước. Soạn hồ sơ, nộp thay, đại diện hoặc dịch vụ chuyên môn có phí cần hợp đồng và thông báo phí riêng với đối tác đủ điều kiện."] },
      ...
      { title: "6. Tệp đính kèm", paragraphs: ["Tệp có thể được lưu tạm để kiểm tra bảo mật và OCR. KARXY không phải kho lưu trữ; bạn phải giữ bản gốc của mình."] },
      { title: "7. Vận hành beta và thay đổi", paragraphs: ["Dịch vụ đang ở giai đoạn beta. KARXY có thể sửa hoặc tạm dừng tính năng vì an toàn, pháp lý, nhà cung cấp hoặc vận hành, và sẽ thông báo thay đổi quan trọng khi cần."] },
  ...
  mn: {
    ...
    privacySummary: "KARXY чат, зөвлөхөд шилжүүлэх болон хавсралтын мэдээллийг хэрхэн боловсруулдаг тухай.",
    termsTitle: "Үйлчилгээний нөхцөл",
    termsSummary: "KARXY-ийн AI зөвлөгөө болон зөвлөхтэй холбох үйлчилгээг ашиглах дүрэм.",
    ...
    termsLink: "Нөхцөл",
    privacySections: [
      { title: "1. Мэдээлэл хариуцагч ба хүсэлтийн суваг", paragraphs: ["Мэдээлэл хариуцагч нь KARXY. Нууцлалын хүсэлтийг энэ хуудасны доорх цахим маягтаар хүлээн авна."] },
      ...
      { title: "6. Хамгаалалт ба устгал", paragraphs: ["KARXY шифрлэгдсэн холболт, эмзэг талбарын шифрлэлт эсвэл халхлалт, админы эрхийн хяналт, аудитын бичлэг ашигладаг. Хугацаа дуусах эсвэл баталгаажсан устгах хүсэлтийн дараа бичлэг ба файлыг устгана."] },
    ...
    termsSections: [
      { title: "1. Үйлчилгээний хүрээ", paragraphs: ["KARXY нь Солонгост сурах бэлтгэлийн мэдээлэл, сургууль ба зардлын хэрэгсэл, албан эх сурвалжтай AI мэдээлэл, ажилтан эсвэл бие даасан түнштэй холболт өгнө."] },
      ...
      { title: "3. Зөвлөгөө ба түнш", paragraphs: ["KARXY нь хууль, захиргааны үйлчилгээний газар, сургууль эсвэл төрийн байгууллага биш. Хэрэгт зориулсан баримт бичиг, төлөөлөл, төлбөртэй мэргэжлийн ажил нь мэргэшсэн түнштэй тусдаа гэрээ, төлбөрийн мэдэгдэл шаарддаг."] },
      ...
      { title: "6. Хавсралт", paragraphs: ["Хавсралтыг аюулгүй байдлын шалгалт болон OCR-д түр хадгалж болно. KARXY архив биш тул эх хувийг өөрөө хадгална уу."] },

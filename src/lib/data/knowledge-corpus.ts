...
export const KNOWLEDGE_DOCS: KnowledgeDoc[] = [
  ...
  {
    id: "study-in-korea-d10-change-documents",
    category: "documents",
    title: {
  ...
  },
  {
    ...
    title: {
      ko: "한국 학위과정 연간 등록금",
      vi: "Học phí hằng năm của chương trình cấp bằng tại Hàn Quốc",
      mn: "Солонгосын зэрэг олгох хөтөлбөрийн жилийн төлбөр",
      en: "Annual tuition for Korean degree programs",
    },
    keywords: ["비용", "cost", "chi phí", "зардал", "tuition", "등록금", "국공립", "사립", "학부", "대학원"],
    content: {
      ko: "정부 운영 Study in Korea 유학경비 페이지의 2026-08-10 확인값 기준, 학위과정 연간 등록금 전국 평균은 대학 6,820,243.8원, 전문학사 6,016,387.8원, 대학원 4,216,103.2원입니다. 대학은 국·공립 평균 4,265,841.8원, 사립 평균 7,625,335.6원이며 전공별 평균도 인문사회 6,003,000원부터 의학 9,843,400원까지 차이가 있습니다. 이는 평균값이므로 실제 금액은 지원 대학의 공식 모집요강이나 대학알리미에서 확인해야 합니다.",
      vi: "Theo trang Chi phí du học của Study in Korea do Chính phủ Hàn Quốc vận hành, kiểm tra ngày 2026-08-10, học phí hằng năm trung bình là 6.820.243,8 KRW cho đại học, 6.016.387,8 KRW cho cao đẳng và 4.216.103,2 KRW cho cao học. Đại học công lập trung bình 4.265.841,8 KRW và tư thục 7.625.335,6 KRW. Đây là số trung bình; cần kiểm tra số thực tế trong thông báo tuyển sinh chính thức của trường hoặc Academy Info.",
      mn: "Солонгосын Засгийн газрын Study in Korea сургалтын зардлын хуудсыг 2026-08-10-нд шалгасан дүнгээр жилийн дундаж төлбөр бакалаврт 6,820,243.8 KRW, коллежид 6,016,387.8 KRW, магистр/докторт 4,216,103.2 KRW байна. Улсын их сургуулийн дундаж 4,265,841.8 KRW, хувийн сургуулийнх 7,625,335.6 KRW. Эдгээр нь дундаж тул бодит төлбөрийг сургуулийн албан элсэлтийн заавар эсвэл Academy Info-оос шалгана.",
      en: "According to the Korean government-run Study in Korea study-expenses page, checked on 2026-08-10, average annual tuition is KRW 6,820,243.8 for undergraduate university programs, KRW 6,016,387.8 for associate-degree programs, and KRW 4,216,103.2 for graduate programs. The undergraduate average is KRW 4,265,841.8 at national/public universities and KRW 7,625,335.6 at private universities. These are averages; verify the actual amount in the university's official admissions guide or Academy Info.",
    },
    source: "Study in Korea · 유학경비",
  },
  {
    id: "living-cost-breakdown",
    category: "cost",
    title: {
      ko: "한국 유학 월 생활비",
      vi: "Chi phí sinh hoạt hằng tháng khi du học Hàn Quốc",
      mn: "Солонгост суралцах сарын амьжиргааны зардал",
      en: "Monthly living costs for studying in Korea",
    },
    keywords: ["생활비", "주거비", "식비", "교통비", "통신비", "living expenses", "housing", "food", "transport", "chi phí sinh hoạt", "зардал"],
    content: {
      ko: "정부 운영 Study in Korea 생활비 페이지의 2026-08-10 확인값 기준, 유학생 1인의 월평균 생활비는 약 750,000~1,000,000원입니다. 페이지는 월 주거비 500,000~700,000원, 식비 200,000~300,000원, 교통비 50,000~100,000원, 통신비·건강보험 등을 포함한 기타 비용 100,000~200,000원을 제시합니다. 항목 범위는 서로 단순 합산한 고정 총액이 아니며 지역, 주거 형태, 식사 포함 여부에 따라 달라집니다.",
      vi: "Theo trang Chi phí sinh hoạt của Study in Korea do Chính phủ Hàn Quốc vận hành, kiểm tra ngày 2026-08-10, mức sinh hoạt trung bình của một du học sinh là khoảng 750.000-1.000.000 KRW mỗi tháng. Trang nêu nhà ở 500.000-700.000 KRW, ăn uống 200.000-300.000 KRW, đi lại 50.000-100.000 KRW và chi phí khác như liên lạc, bảo hiểm 100.000-200.000 KRW. Chi phí thực tế thay đổi theo khu vực và hình thức nhà ở.",
      mn: "Солонгосын Засгийн газрын Study in Korea амьжиргааны зардлын хуудсыг 2026-08-10-нд шалгасан дүнгээр нэг оюутны сарын дундаж зардал ойролцоогоор 750,000-1,000,000 KRW. Орон сууц 500,000-700,000 KRW, хоол 200,000-300,000 KRW, тээвэр 50,000-100,000 KRW, холбоо ба эрүүл мэндийн даатгал зэрэг бусад зардал 100,000-200,000 KRW гэж үзүүлсэн. Бодит дүн бүс нутаг, сууцны хэлбэрээс хамаарна.",
      en: "According to the Korean government-run Study in Korea living-expenses page, checked on 2026-08-10, average monthly living expenses for one international student are approximately KRW 750,000-1,000,000. The page lists housing at KRW 500,000-700,000, food at KRW 200,000-300,000, transportation at KRW 50,000-100,000, and other expenses such as communications and health insurance at KRW 100,000-200,000. Actual costs vary by region and housing arrangement.",
    },
    source: "Study in Korea · 생활비 및 경비",
  },
  {
  ...
  },
  {
    ...
    content: {
      ko: "비자 발급 여부는 영사의 재량이며, 어떤 브로커나 유학원도 '비자 100% 보장'을 약속할 수 없습니다. 비자 보장을 약속하는 것은 허위 광고에 해당하며, 계약 후 비자 거절시 책임을 회피하는 경우가 많습니다. KARXY는 비자 발급을 보장하지 않으며, 비자 가능성을 판단하지 않습니다. 개별 비자 판단은 행정사 상담으로 연결됩니다.",
      vi: "Visa do lãnh sự quyết định. Không ai bảo đảm 100% visa. Hứa 'bảo đảm visa' là quảng cáo giả. Nền tảng không bảo đảm visa, chuyển sang chuyên gia hành chính cho từng trường hợp.",
      ...
      en: "Visa is at consul's discretion. No one can guarantee 100% visa. 'Visa guarantee' is false advertising. Platform does not guarantee visa, refers to an administrative scrivener for individual cases.",
    },
    source: "KARXY 안전 가이드라인",
  },
  {
    ...
    content: {
      ko: "허위 잔고증명·허위 학력증명서·허위 재직증명서 제출은 출입국관리법 위반으로 강제퇴거·입국금지(최장 10년) 대상입니다. 또한 사문서위조죄(형법 제231조)로 형사처벌 대상입니다. KARXY는 허위서류 작성·제공을 요청하는 사용자에게 서비스를 제공하지 않으며, 합법적 준비 경로를 안내합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "미등록 유료직업소개사업은 직업안정법 제47조 위반으로 5년 이하 징역 또는 5천만원 이하 벌금 대상입니다. D-2/D-4 비자 소지자의 아르바이트는 별도 시간제취업허가(S-3)를 받아야 하며, 허가 없는 취업은 불법취업으로 강제퇴거 대상입니다. KARXY는 취업 매칭을 제공하지 않으며, 합법 취업은 고용노동부 고용허가제를 통해야 함을 안내합니다.",
  ...
  },
  {
    ...
    title: {
      ko: "행정사 업무 영역",
      vi: "Lĩnh vực chuyên gia hành chính",
    ...
    content: {
      ko: "행정사법 제2조에 따라 행정사는 행정기관 제출 서류 작성, 권리·의무나 사실증명 서류 작성, 작성된 서류의 제출 대행 등을 업무로 합니다. 비자 신청서 작성, 출입국 제출서류 작성, 체류자격 변경 신청 대행은 행정사 영역입니다. KARXY는 일반 안내만 제공하며, 개별 비자 판단·서류 작성·제출 대행은 행정사 파트너에게 위탁합니다.",
      vi: "Theo Luật Chuyên gia hành chính, chuyên gia hành chính được phép soạn hồ sơ nộp cơ quan, đại diện nộp. Visa, thay đổi tư cách lưu trú → cần chuyên gia hành chính. Nền tảng chỉ hướng dẫn chung.",
      ...
      en: "Per Admin Scrivener Act Art. 2, administrative scriveners prepare administrative documents and submit on behalf. Visa applications and stay status changes need an administrative scrivener. Platform provides general guidance only.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "KARXY는 국가법령정보센터의 최근공포법령과 본문을 함께 감시합니다. 2026-07-02 확인 기준 출입국관리법은 2025-07-22 일부개정·2026-01-23 시행본, 출입국관리법 시행규칙은 2026-01-23 시행본, 출입국관리법 시행령은 2025-05-27 시행본을 기준으로 봅니다. 최근공포/시행예정 항목에 새 법률·시행령·시행규칙이 보이면 자동 크롤러는 production RAG를 직접 바꾸지 않고 PENDING 후보와 영향 rule/user 목록을 생성해야 합니다.",
      vi: "KARXY theo dõi đồng thời danh sách luật mới ban hành và văn bản hiện hành trên cổng luật quốc gia. Tại thời điểm kiểm tra 2026-07-02, căn cứ là Luật quản lý xuất nhập cảnh hiệu lực 2026-01-23, Quy tắc thi hành hiệu lực 2026-01-23 và Nghị định thi hành hiệu lực 2025-05-27. Nếu có văn bản mới hoặc ngày hiệu lực mới, crawler chỉ tạo ứng viên PENDING và danh sách rule/người dùng bị ảnh hưởng.",
      mn: "KARXY нь үндэсний хууль мэдээллийн төвийн шинэчлэгдсэн хууль болон хүчинтэй эхийг хамтад нь хянадаг. 2026-07-02-ны шалгалтаар Цагаачлалын хууль 2026-01-23, хэрэгжүүлэх дүрэм 2026-01-23, хэрэгжүүлэх журам 2025-05-27 хүчинтэй эхийг суурь болгож байна. Шинэ хүчинтэй огноо илэрвэл crawler нь production RAG-г шууд өөрчлөхгүй, PENDING нэр дэвшигч ба нөлөөлөх rule/user жагсаалт үүсгэнэ.",
      en: "KARXY monitors both the National Law Information Center's recent-promulgation list and current statutory text. As checked on 2026-07-02, the Immigration Act basis is the 2026-01-23 effective text, the Enforcement Rule is the 2026-01-23 effective text, and the Enforcement Decree is the 2025-05-27 effective text. New promulgations or effective dates must create PENDING candidates and impact lists, not direct production RAG changes.",
    },
  ...
  },
  {
    ...
    content: {
      ...
      mn: "8 дугаар зүйл нь нэг удаагийн виз ба олон удаагийн визийг ялгаж, виз олгох шалгуур, журмыг Хууль зүйн яамны дүрэмд даалгана. 9 дүгээр зүйлээр Хууль зүйн сайд шаардлагатай гэж үзвэл нэвтрэх гэж буй гадаад иргэний хүсэлтээр виз олгох зөвшөөрлийн бичиг гаргаж болох ба тухайн хүнийг урих этгээд хүсэлтийг төлөөлөн гаргаж болно. D-2/D-4, E-7, E-8, F-6 зэрэг сургууль, ажил олгогч, уригч оролцсон хэрэгт KARXY зөвшөөрлийн бичиг шаардлагатай эсэх, уригчийн төлөөлөх эрх, гадаад дахь консулын визийн шат, хавсаргах материалыг шалгана.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제10조의2는 일반체류자격을 단기체류자격과 장기체류자격으로 나눕니다. 단기체류자격은 관광·방문 등의 목적으로 원칙적으로 90일 이하 머무는 체류자격이고, 장기체류자격은 유학, 연수, 투자, 주재, 결혼 등의 목적으로 90일을 초과하여 법무부령상 체류기간 상한 범위에서 거주할 수 있는 체류자격입니다. 따라서 KARXY는 C-3 같은 단기방문과 D-2, D-4, D-10, E-7, F-2 같은 장기체류자격을 답변 초반에 분리하고, 90일 기준·활동 목적·시행령 별표상 해당성을 함께 확인해야 합니다.",
      ...
      mn: "10-2 дугаар зүйл нь ердийн оршин суух ангиллыг богино хугацааны болон урт хугацааны ангилалд хуваадаг. Богино хугацаа нь аялал, айлчлал зэрэг зорилгоор зарчмаар 90 хоногоос ихгүй байх ангилал. Урт хугацаа нь суралцах, дадлага, хөрөнгө оруулалт, томилолт, гэрлэлт зэрэг зорилгоор 90 хоногоос дээш, Хууль зүйн яамны дүрэмд заасан дээд хугацааны хүрээнд оршин суух ангилал. KARXY C-3 богино хугацаа ба D-2, D-4, D-10, E-7, F-2 урт хугацааг ялгаж, 90 хоног, зорилго, журам дахь хүснэгтийг шалгана.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제11조는 법무부장관이 특정 외국인에 대해 입국을 금지하거나 거부할 수 있는 위험 사유를 둡니다. 공중위생상 위해, 공공의 안전·대한민국의 이익 침해 우려, 경제질서·사회질서·선량한 풍속 침해 우려, 국내체류비용 부담 능력 부족, 강제퇴거명령으로 출국 후 일정 기간이 지나지 않은 경우 등이 입국 단계의 핵심 리스크입니다. KARXY는 비자 발급 가능성이나 입국 가능성을 단정하지 않고, 과거 강제퇴거·출국명령·범죄·감염병·체류비용·초청 경위가 있으면 관할 재외공관 또는 출입국외국인관서 확인과 행정사 검토를 우선 안내해야 합니다.",
      vi: "Điều 11 của Luật Quản lý xuất nhập cảnh đặt các căn cứ mà Bộ trưởng Tư pháp có thể cấm hoặc từ chối nhập cảnh. Rủi ro gồm nguy hại y tế công cộng, nguy cơ xâm hại an toàn công cộng hoặc lợi ích của Hàn Quốc, trật tự kinh tế/xã hội hoặc thuần phong mỹ tục, không đủ khả năng chi trả chi phí lưu trú, hoặc chưa đủ thời gian sau khi rời Hàn Quốc theo lệnh trục xuất. KARXY không được bảo đảm khả năng nhập cảnh; nếu có tiền sử trục xuất, lệnh xuất cảnh, án tích, bệnh truyền nhiễm, thiếu tài chính hoặc nghi vấn về thư mời, cần hướng dẫn kiểm tra với cơ quan có thẩm quyền và chuyên gia hành chính.",
      mn: "Цагаачлалын хуулийн 11 дүгээр зүйл нь Хууль зүйн сайд тодорхой гадаад иргэнийг нэвтрүүлэхийг хориглох эсвэл татгалзах үндэслэлийг тогтоодог. Нийтийн эрүүл мэнд, нийтийн аюулгүй байдал эсвэл Солонгосын ашиг сонирхолд хор учруулах эрсдэл, эдийн засаг/нийгмийн дэг журам, оршин суух зардал даах чадваргүй байдал, албадан гаргаснаас хойш шаардлагатай хугацаа өнгөрөөгүй байдал зэрэг нь гол эрсдэл. KARXY нэвтрэх боломжийг батлахгүй, өмнөх албадан гаргалт, гарах тушаал, гэмт хэрэг, өвчин, санхүү, урилга зэрэгт эрх бүхий байгууллага ба мэргэжилтний шалгалтыг зөвлөнө.",
      en: "Immigration Act Article 11 sets entry-ban and entry-refusal risk grounds. Key issues include public-health risk, risk to public safety or Korean interests, risk to economic or social order or good morals, inability to bear stay costs, and insufficient time after departure under a deportation order. KARXY must not guarantee entry or visa issuance; where there is prior deportation, departure order, criminal history, infectious-disease issue, funding weakness, or invitation concern, the answer should route to the competent mission or immigration office and administrative-scrivener review.",
    },
    source: "출입국관리법 제11조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제12조는 외국인이 입국할 때 여권과 입국신고서를 제출해 입국심사를 받고, 유효한 여권·필요한 사증 또는 사전여행허가, 체류자격에 맞는 입국목적, 법무부령상 체류기간, 입국금지·거부 대상 아님을 확인받는 구조를 둡니다. KARXY는 C-3, K-ETA, D-2/D-4 입국 상담에서 사증 소지 여부만 보지 말고, 실제 입국목적과 체류자격의 일치, 왕복항공권·숙소·재정자료, 입국금지 사유, 전자입국신고 또는 K-ETA 적용 여부를 함께 확인해야 합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 시행규칙 제31조의2는 체류자격 부여, 체류자격 변경허가, 체류기간 연장허가를 할 때 외국인이 제9조의2제1호부터 제3호까지, 제5호 및 제6호의 요건을 갖추었는지 심사해야 한다고 정합니다. 이 구조는 단순히 서류 목록을 맞추는 문제가 아니라 유효한 여권, 입국금지·거부 대상 여부, 시행령 별표 1·1의2·1의3의 체류자격 해당성, 체류자격별 법무부장관 기준 등을 함께 보는 심사입니다. 따라서 KARXY는 변경·연장 가능성을 단정하지 않고, 현재 체류자격, 만료일, 활동 목적, 위반 이력, 관할관서 판단 가능성을 함께 확인해야 합니다.",
      vi: "Điều 31-2 của Quy tắc thi hành yêu cầu khi cấp tư cách lưu trú, cho phép đổi tư cách hoặc gia hạn thời hạn lưu trú, cơ quan phải xem xét người nước ngoài có đáp ứng các điều kiện tại Điều 9-2 khoản 1 đến 3, 5 và 6 hay không. Đây không chỉ là kiểm tra danh sách hồ sơ; còn gồm hộ chiếu hợp lệ, có thuộc diện cấm/từ chối nhập cảnh không, có phù hợp với tư cách trong các phụ lục 1, 1-2, 1-3 của Nghị định không, và có đáp ứng tiêu chuẩn do Bộ trưởng Tư pháp đặt ra cho từng tư cách không. Vì vậy KARXY không được cam kết khả năng đổi/gia hạn mà phải kiểm tra tư cách hiện tại, ngày hết hạn, mục đích hoạt động, lịch sử vi phạm và quyết định của văn phòng có thẩm quyền.",
      mn: "Хэрэгжүүлэх дүрмийн 31-2 дугаар зүйл нь оршин суух ангилал олгох, ангилал өөрчлөх, хугацаа сунгах үед гадаад иргэн 9-2 дугаар зүйлийн 1-3, 5, 6 дахь нөхцөлийг хангасан эсэхийг шалгахыг шаарддаг. Энэ нь зөвхөн материалын жагсаалт биш; хүчинтэй паспорт, нэвтрэх хориг/татгалзах үндэслэл, хэрэгжүүлэх журмын 1, 1-2, 1-3 дугаар хавсралтын ангилалд нийцэх эсэх, тухайн ангиллын Хууль зүйн сайдын шалгуур зэргийг хамтад нь үзнэ. KARXY өөрчлөх/сунгах боломжийг батлахгүй, одоогийн ангилал, хугацаа, үйл ажиллагаа, зөрчлийн түүх, харьяа байгууллагын шийдвэрийг шалгана.",
      en: "Article 31-2 of the Enforcement Rule requires immigration offices, when granting a status, approving a status change, or extending a stay period, to review whether the foreign national satisfies the relevant requirements in Article 9-2. This is not just a document-list check; it includes valid passport status, entry-ban or denial grounds, whether the person fits the status tables in Enforcement Decree Tables 1, 1-2, and 1-3, and whether status-specific Ministry of Justice standards are satisfied. KARXY therefore must not guarantee change or extension outcomes and must check current status, expiry date, activity purpose, violation history, and competent-office judgment.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제19조는 취업활동을 할 수 있는 체류자격을 가진 외국인을 고용한 자에게 일정한 사유가 생기면 15일 이내 신고의무를 둡니다. 고용계약 해지, 퇴직, 사망, 소재불명, 고용계약의 중요 내용 변경처럼 외국인의 취업·체류 심사에 영향을 줄 수 있는 사건은 근무처 변경허가나 체류자격 문제와 별도로 사업주 신고 리스크가 생깁니다. KARXY는 E-7 등 취업자격 상담에서 외국인 본인의 허가뿐 아니라 고용주의 신고기한, 변경일, 퇴직일, 새 근무처 시작일, 계약서 변경 내용을 함께 확인해야 합니다.",
      ...
      mn: "Цагаачлалын хуулийн 19 дүгээр зүйл нь ажиллах эрхтэй гадаад иргэнийг ажиллуулж буй этгээдэд тодорхой нөхцөл үүсвэл 15 хоногийн дотор мэдэгдэх үүрэг тогтоодог. Гэрээ дуусах, ажлаас гарах, нас барах, байршил тодорхойгүй болох, хөдөлмөрийн гэрээний чухал нөхцөл өөрчлөгдөх зэрэг нь ажилтны ажлын байр өөрчлөх зөвшөөрлөөс гадна ажил олгогчийн мэдэгдлийн эрсдэл үүсгэнэ. KARXY E-7 зэрэг ажиллах ангиллын зөвлөгөөнд ажил олгогчийн хугацаа, өөрчлөгдсөн өдөр, ажлаас гарсан өдөр, шинэ ажлын эхлэх өдөр, гэрээний өөрчлөлтийг шалгана.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제19조의4는 외국인유학생을 받는 학교의 관리·신고 구조를 둡니다. D-2, D-4 유학생이 휴학, 제적, 미등록, 연수 중단, 행방불명 등 학업 지속성과 체류자격 유지에 영향을 주는 상태가 되면 학교의 신고와 출입국 심사 리스크가 함께 발생할 수 있습니다. KARXY는 유학생 상담에서 본인의 체류기간 연장·변경 요건만 보지 말고, 학적 상태, 학교 국제처 통보 여부, 변동일, 유학생정보시스템 반영 여부, 관할 출입국·외국인관서의 추가 요구를 확인해야 합니다.",
  ...
  },
  {
    ...
    content: {
      ...
      en: "Article 20 requires advance permission for activities outside status when a foreign national keeps the current status activity while also performing an activity belonging to another status. Student part-time work for D-2 or D-4-1 is therefore not just a yes/no question; KARXY should check current-status maintenance, school confirmation, work-hour and industry limits, and HiKorea permission or reporting availability. If the new activity becomes the primary activity, status change may be the correct route instead.",
    },
    source: "출입국관리법 제20조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제21조는 외국인이 체류자격의 범위 안에서 근무처를 변경하거나 추가하려면 원칙적으로 미리 법무부장관의 허가를 받아야 한다고 정합니다. 다만 전문 지식·기술·기능을 가진 사람으로서 대통령령이 정하는 사람은 근무처를 변경하거나 추가한 날부터 15일 이내 신고 구조가 적용될 수 있습니다. 허가·신고 없이 근무처를 바꾼 외국인을 고용하거나 고용을 알선하는 것도 금지됩니다. KARXY는 E-계열, E-7, 연구·전문직 상담에서 현재 지정 근무처, 새 계약 시작일, 신고 대상인지 허가 대상인지, 고용주·알선자 리스크를 함께 확인해야 합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제22조는 법무부장관이 공공의 안녕질서나 대한민국의 중요한 이익을 위해 필요하다고 인정하면 대한민국에 체류하는 외국인에 대해 거소 또는 활동의 범위를 제한하거나 필요한 준수사항을 정할 수 있다고 합니다. 이 조문은 일반적인 체류자격 판단과 달리 개별 사안의 제한·조건 부과 근거가 될 수 있으므로, KARXY는 특정 지역·활동 제한, 출석 요구, 준수조건 위반 가능성이 보이면 단정 답변을 피하고 결정서·통지서와 관할관서 확인을 요구해야 합니다.",
      vi: "Điều 22 cho phép Bộ trưởng Tư pháp hạn chế nơi cư trú hoặc phạm vi hoạt động của người nước ngoài đang ở Hàn Quốc, hoặc đặt ra nghĩa vụ tuân thủ cần thiết, khi cần vì trật tự công cộng hoặc lợi ích quan trọng của Hàn Quốc. Đây có thể là căn cứ cho điều kiện hoặc hạn chế cá biệt, nên nếu có giấy thông báo, yêu cầu có mặt, hạn chế khu vực/hoạt động hoặc nguy cơ vi phạm điều kiện, KARXY không nên kết luận chắc chắn mà cần kiểm tra văn bản và cơ quan có thẩm quyền.",
      mn: "22 дугаар зүйлээр нийтийн аюулгүй байдал, дэг журам эсвэл Солонгосын чухал ашиг сонирхолд шаардлагатай гэж үзвэл Хууль зүйн сайд гадаад иргэний оршин суух газар, үйл ажиллагааны хүрээг хязгаарлах эсвэл дагах нөхцөл тогтоож болно. Энэ нь хувь хэрэгт тавигдсан хязгаар, нөхцлийн үндэс байж болох тул KARXY мэдэгдэл, ирэх шаардлага, бүс/үйл ажиллагааны хязгаар, нөхцөл зөрчих эрсдэл байвал бичиг баримт болон харьяа байгууллагыг шалгуулна.",
      en: "Article 22 allows the Minister of Justice, when necessary for public order or important Korean interests, to restrict a foreign national's place of residence or scope of activity, or set other required compliance conditions. Because this can support case-specific restrictions or conditions, KARXY should avoid categorical advice when a notice, appearance request, regional or activity restriction, or compliance-condition issue appears, and should require review of the official notice and competent-office confirmation.",
    },
    source: "출입국관리법 제22조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제26조는 체류자격 외 활동, 근무처 변경·추가, 체류자격 부여·변경·연장 등 허가 신청과 관련하여 위조·변조 문서나 거짓 사실이 적힌 신청서 등을 제출하는 부정 신청과, 그런 행위를 알선·권유하는 행위를 금지합니다. KARXY는 잔고증명, 재직증명, 고용계약, 학교서류, 초청서 등에서 허위 작성·대여·브로커 알선 요청이 감지되면 서비스를 거절하고, 정정·철회·합법 자료 준비와 행정사 검토로 안내해야 합니다.",
      vi: "Điều 26 cấm nộp hồ sơ giả, tài liệu bị làm giả/sửa đổi hoặc đơn có nội dung sai sự thật trong các hồ sơ xin phép như hoạt động ngoài tư cách, thay đổi/thêm nơi làm việc, cấp/đổi/gia hạn tư cách lưu trú; đồng thời cấm môi giới hoặc khuyến dụ hành vi đó. Nếu KARXY phát hiện yêu cầu làm giả chứng minh tài chính, chứng nhận việc làm, hợp đồng lao động, giấy tờ trường học hoặc thư mời, cần từ chối hỗ trợ và hướng dẫn sửa, rút hồ sơ hoặc chuẩn bị tài liệu hợp pháp với hành chính viên.",
      mn: "26 дугаар зүйл нь ангиллаас гадуурх үйл ажиллагаа, ажлын байр өөрчлөх/нэмэх, ангилал олгох/өөрчлөх/сунгах зэрэг зөвшөөрлийн хүсэлтэд хуурамч, өөрчилсөн бичиг баримт эсвэл худал мэдээлэлтэй өргөдөл өгөх, мөн түүнийг зуучлах/санал болгохыг хориглодог. KARXY санхүүгийн баталгаа, ажил эрхлэлтийн тодорхойлолт, хөдөлмөрийн гэрээ, сургуулийн материал, урилга зэрэгт хуурамч хүсэлт илэрвэл татгалзаж, засах/буцаах/хууль ёсны материал бэлтгэхийг зөвлөнө.",
      en: "Article 26 prohibits fraudulent applications using forged or altered documents, or applications containing false facts, in permission matters such as outside-status activity, workplace change or addition, grant, change, or extension of stay status; it also prohibits brokering or encouraging those acts. If KARXY detects requests to fabricate bank balances, employment certificates, employment contracts, school documents, or invitation letters, it should refuse assistance and route the user toward correction, withdrawal, lawful evidence preparation, and administrative-scrivener review.",
    },
    source: "출입국관리법 제26조",
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      mn: "Цагаачлалын хуулийн 24 дүгээр зүйлээр Солонгост байгаа гадаад иргэн одоогийн ангиллаас өөр ангиллын үйл ажиллагаа хийх бол журмаар тогтоосны дагуу урьдчилан Хууль зүйн сайдын ангилал өөрчлөх зөвшөөрөл авах ёстой. 31 дүгээр зүйлийн 1 дэх хэсгийн бүлэгт байсан хүн статус нь өөрчлөгдвөл өөрчлөгдсөн өдрөөс 30 хоногийн дотор зөвшөөрөл авах ёстой. Шалгуурыг Хууль зүйн яамны дүрэм тогтоодог тул KARXY шинэ үйл ажиллагаа эхэлсэн эсэх, одоогийн үйл ажиллагаагаа зогсоосон эсэх, дотоодод өөрчлөх боломжтой эсэх, журам/хавсралт/HiKorea зааврыг хамт шалгана.",
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제25조의2는 가정폭력, 성폭력범죄, 아동학대범죄, 인신매매등 피해와 관련해 재판·수사 또는 법률상 권리구제 절차가 진행 중인 외국인이 체류기간 연장허가를 신청하는 경우, 그 절차가 끝날 때까지 체류기간 연장을 허가할 수 있는 특칙을 둡니다. 이 조항은 특히 국민의 배우자인 결혼이민자, 성폭력·아동학대·인신매매 피해자가 체류자격 상실이나 만료 위험 속에서도 권리구제 절차를 진행할 수 있게 하는 안전장치입니다. KARXY는 폭력·학대·피해 호소가 있으면 단순 F-6 연장 가능성만 보지 말고 사건 진행 여부, 보호명령·고소·수사·재판 자료, 신변안전, 행정사와 피해자 지원기관 연계를 우선 확인해야 합니다.",
      vi: "Điều 25-2 cho phép gia hạn thời hạn lưu trú đến khi kết thúc thủ tục tố tụng, điều tra hoặc cứu trợ quyền lợi nếu người nước ngoài là nạn nhân liên quan đến bạo lực gia đình, tội phạm tình dục, lạm dụng trẻ em hoặc mua bán người và xin gia hạn lưu trú. Quy định này đặc biệt bảo vệ người kết hôn với công dân Hàn Quốc, nạn nhân bạo lực tình dục, lạm dụng trẻ em hoặc mua bán người khi có nguy cơ hết hạn hoặc mất tư cách lưu trú. KARXY phải kiểm tra tiến trình vụ việc, lệnh bảo vệ, đơn tố cáo, hồ sơ điều tra/tòa án, an toàn cá nhân và kết nối hành chính viên hoặc tổ chức hỗ trợ nạn nhân.",
      mn: "25-2 дугаар зүйл нь гэр бүлийн хүчирхийлэл, бэлгийн гэмт хэрэг, хүүхдийн хүчирхийлэл, хүн худалдаалахтай холбоотой шүүх, мөрдөн шалгах эсвэл эрх хамгаалах ажиллагаа явагдаж байгаа гадаад иргэн хугацаа сунгах хүсэлт гаргавал тухайн ажиллагаа дуусах хүртэл сунгах боломжтой тусгай журамтай. Энэ нь Солонгос иргэний эхнэр/нөхөр, бэлгийн хүчирхийлэл, хүүхдийн хүчирхийлэл, хүн худалдаалах гэмт хэргийн хохирогчийн эрх хамгаалах ажиллагааг дэмжих хамгаалалт. KARXY хэрэг явц, хамгаалах захирамж, гомдол, мөрдөн шалгах/шүүх материал, аюулгүй байдал, мэргэжлийн тусламжийг шалгана.",
      en: "Article 25-2 allows stay extension until the end of court, investigation, or other legal relief procedures when a foreign national applies for extension in connection with domestic violence, sexual crime, child abuse, or human-trafficking victimization. This is a protective rule for marriage immigrants who are spouses of Korean nationals and for sexual-violence, child-abuse, and human-trafficking victims facing status-expiry or status-loss risk. If KARXY detects violence, abuse, or victimization, it should not treat the case as a routine F-6 extension; it should check case status, protection orders, complaint, investigation or court records, personal safety, and referral to an administrative scrivener and victim-support organization.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제28조는 외국인이 출국할 때 유효한 여권을 가지고 출국하는 출입국항에서 출입국관리공무원의 출국심사를 받아야 한다고 정합니다. 출국심사에서는 유효 여권, 위조·변조 여권 문제, 출입국항이 아닌 장소에서의 심사, 선박·항공기 출입, 생체정보 활용이 함께 문제될 수 있습니다. KARXY는 출국 상담에서 단순 항공권 여부만 보지 말고 여권 유효성, 체류기간 만료일, 출국정지 가능성, 외국인등록증 반납·재입국허가 여부, 공항·항만 출국심사 절차를 함께 확인해야 합니다.",
      vi: "Điều 28 Luật Quản lý xuất nhập cảnh yêu cầu người nước ngoài khi rời Hàn Quốc phải có hộ chiếu hợp lệ và chịu kiểm tra xuất cảnh tại cửa khẩu xuất cảnh. Khi kiểm tra có thể phát sinh vấn đề hộ chiếu giả hoặc bị sửa đổi, kiểm tra tại nơi không phải cửa khẩu thông thường, tàu bay/tàu biển và sử dụng thông tin sinh trắc học. KARXY cần kiểm tra hiệu lực hộ chiếu, ngày hết hạn lưu trú, khả năng bị đình chỉ xuất cảnh, việc nộp thẻ đăng ký người nước ngoài hoặc giấy phép tái nhập, và quy trình tại sân bay/cảng.",
      mn: "Цагаачлалын хуулийн 28 дугаар зүйлээр гадаад иргэн Солонгосоос гарахдаа хүчинтэй паспорттой байж, гарах боомт дээр цагаачлалын ажилтны гарах шалгалтад орно. Шалгалтад паспортын хүчинтэй байдал, хуурамч/өөрчилсөн паспорт, ердийн боомтоос өөр газарт шалгах, нисэх онгоц/хөлөг онгоц, биометр мэдээлэл ашиглах асуудал орж болно. KARXY гарах зөвлөгөөнд паспорт, хугацаа дуусах өдөр, гарахыг түр зогсоох эрсдэл, бүртгэлийн карт/дахин орох зөвшөөрөл, нисэх буудал/боомтын журмыг шалгана.",
      en: "Immigration Act Article 28 requires a foreign national departing Korea to hold a valid passport and undergo departure inspection by an immigration officer at the departure port. Departure inspection can involve passport validity, forged or altered passport issues, inspection outside ordinary ports, vessel or aircraft procedures, and use of biometric information. KARXY should check passport validity, stay-period expiry, possible departure suspension, alien registration card return or re-entry permission, and airport or seaport departure procedure together.",
    },
    source: "출입국관리법 제28조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제29조는 법무부장관이 제4조 제1항 또는 제2항 각 호에 해당하는 외국인에 대해 출국을 정지할 수 있다고 정합니다. 이 조항은 내국인 출국금지 구조 일부를 준용하므로, 형사재판·수사, 형 집행, 벌금·추징금·세금 등 미납, 공공안전·경제질서 관련 사유가 있으면 출국이 막힐 수 있습니다. KARXY는 '비행기를 타면 나갈 수 있느냐'는 질문에서 체류기간뿐 아니라 출국정지 통지, 사건번호, 체납·벌금·범칙금, 이의신청 또는 해제 신청 가능성을 확인하고 행정사·변호사 검토를 안내해야 합니다.",
      vi: "Điều 29 Luật Quản lý xuất nhập cảnh cho phép Bộ trưởng Tư pháp đình chỉ xuất cảnh đối với người nước ngoài thuộc các căn cứ được viện dẫn từ Điều 4. Cơ chế này áp dụng tương tự một số quy định về cấm xuất cảnh, nên phiên tòa hoặc điều tra hình sự, thi hành án, tiền phạt/thu hồi/thuế chưa nộp, hoặc lý do an toàn công cộng, trật tự kinh tế có thể làm người đó không rời Hàn Quốc được. KARXY phải kiểm tra thông báo đình chỉ, số vụ việc, nợ thuế/phạt, và khả năng khiếu nại hoặc xin gỡ đình chỉ.",
      mn: "Цагаачлалын хуулийн 29 дүгээр зүйл нь 4 дүгээр зүйлд заасан үндэслэлтэй гадаад иргэний гарахыг Хууль зүйн сайд түр зогсоож болохыг тогтоодог. Эрүүгийн хэрэг, мөрдөн шалгах ажиллагаа, ял биелүүлэх, торгууль/татварын өр, нийтийн аюулгүй байдал, эдийн засгийн дэг журам зэрэг шалтгаан гарч болно. KARXY нислэгээр гарах боломжийг хэлэхдээ зөвхөн визийн хугацааг бус гарахыг зогсоосон мэдэгдэл, хэрэг, өр төлбөр, гомдол эсвэл цуцлуулах хүсэлтийг шалгана.",
      en: "Immigration Act Article 29 allows the Minister of Justice to suspend departure of a foreign national who falls within the referenced Article 4 grounds. Because it borrows parts of the departure-ban framework, criminal trial or investigation, sentence execution, unpaid fines, surcharges or taxes, and public-safety or economic-order grounds can prevent departure. KARXY should not answer departure questions only by checking the flight or stay expiry; it should check any departure-suspension notice, case number, unpaid taxes or fines, and possible objection or cancellation request with administrative-scrivener or attorney review.",
    },
    source: "출입국관리법 제29조",
  },
  {
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제37조는 등록외국인이 출국하거나 대한민국 국적을 취득하거나 사망하는 등 사유가 생겼을 때 외국인등록증 반납·회수 구조를 정합니다. 출국 시에는 원칙적으로 출입국관리공무원에게 등록증을 반납하지만, 재입국허가를 받았거나 복수사증 소지 등 예외가 있으면 반납하지 않는 구조가 문제될 수 있습니다. 일시 보관된 등록증은 다시 입국한 뒤 15일 이내 되찾아야 하는 경우가 있으므로, KARXY는 출국 목적, 재입국허가·면제 여부, 복수사증 여부, 국적취득·사망·분실 사유, 반납 또는 회수 시점을 확인해야 합니다.",
      vi: "Điều 37 Luật Quản lý xuất nhập cảnh quy định cơ chế nộp lại hoặc thu hồi thẻ đăng ký người nước ngoài khi người đã đăng ký xuất cảnh, nhập quốc tịch Hàn Quốc, tử vong hoặc phát sinh lý do tương tự. Khi xuất cảnh, về nguyên tắc thẻ được nộp cho cán bộ xuất nhập cảnh, nhưng có thể có ngoại lệ như giấy phép tái nhập cảnh hoặc thị thực nhiều lần. Nếu thẻ được tạm giữ, có trường hợp phải nhận lại trong vòng 15 ngày sau khi tái nhập. KARXY cần kiểm tra mục đích xuất cảnh, tái nhập, thị thực nhiều lần, quốc tịch, tử vong, mất thẻ và thời điểm nộp hoặc thu hồi.",
      mn: "Цагаачлалын хуулийн 37 дугаар зүйл нь бүртгэлтэй гадаад иргэн гарах, Солонгосын иргэншил авах, нас барах зэрэг үед бүртгэлийн картыг буцаах эсвэл хураах бүтцийг тогтоодог. Гарах үед зарчмаар картыг цагаачлалын ажилтанд буцаадаг боловч дахин нэвтрэх зөвшөөрөл, олон удаагийн виз зэрэг онцгой нөхцөл байж болно. Түр хадгалуулсан картыг дахин орсны дараа 15 хоногийн дотор авах шаардлагатай тохиолдол байдаг. KARXY гарах зорилго, дахин орох зөвшөөрөл/чөлөөлөлт, олон виз, иргэншил, нас баралт, алдагдал, буцаах хугацааг шалгана.",
      en: "Immigration Act Article 37 sets the return and collection framework for an alien registration card when a registered foreign national departs, acquires Korean nationality, dies, or has a similar ground arise. On departure, the card is generally returned to an immigration officer, but exceptions such as re-entry permission or a multiple-entry visa may matter. If the card is temporarily retained, it may need to be recovered within 15 days after re-entry. KARXY should check departure purpose, re-entry permission or exemption, multiple-visa status, nationality acquisition, death or loss grounds, and the return or collection timing.",
    },
    source: "출입국관리법 제37조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제38조는 일정한 외국인에게 지문·얼굴정보 등 생체정보 제공 의무를 둡니다. 17세 이상으로 외국인등록을 하거나 국내거소신고를 하는 사람, 신원 확인이 필요한 조사 대상자 등은 생체정보 제공이 문제될 수 있고, 정당한 사유 없이 제공을 거부하면 체류기간 연장허가 등 체류 관련 허가가 불허될 수 있습니다. KARXY는 외국인등록, 국내거소신고, 조사·단속, 지문 채취 거부 상담에서 나이, 신청 유형, 거부 사유, 이전 등록 이력, 관할관서 안내를 확인해야 합니다.",
      vi: "Điều 38 Luật Quản lý xuất nhập cảnh đặt nghĩa vụ cung cấp thông tin sinh trắc học như vân tay và khuôn mặt đối với một số người nước ngoài. Người từ 17 tuổi trở lên khi đăng ký người nước ngoài hoặc khai báo cư trú trong nước, hoặc người cần xác minh danh tính trong quá trình điều tra, có thể phải cung cấp thông tin này. Nếu từ chối không có lý do chính đáng, các phép liên quan đến lưu trú như gia hạn có thể bị từ chối. KARXY cần kiểm tra tuổi, loại hồ sơ, lý do từ chối, lịch sử đăng ký và hướng dẫn của cơ quan có thẩm quyền.",
      mn: "Цагаачлалын хуулийн 38 дугаар зүйл нь тодорхой гадаад иргэнд хурууны хээ, нүүрний мэдээлэл зэрэг биометр мэдээлэл өгөх үүрэг тогтоодог. 17 ба түүнээс дээш настай бүртгэл хийлгэх эсвэл дотоод оршин суух мэдэгдэл гаргах хүн, мөн шалгалтад иргэний үнэмлэх тогтоох шаардлагатай хүн энэ үүрэгт хамрагдаж болно. Хүндэтгэх шалтгаангүйгээр татгалзвал хугацаа сунгах зэрэг оршин суух зөвшөөрөл татгалзагдаж болзошгүй. KARXY нас, хүсэлтийн төрөл, татгалзсан шалтгаан, өмнөх бүртгэл, харьяа байгууллагын зааврыг шалгана.",
      en: "Immigration Act Article 38 requires biometric information such as fingerprints and facial information from certain foreign nationals. A person aged 17 or older who completes alien registration or a domestic residence report, or a person whose identity needs confirmation during investigation, may fall within the duty. Refusal without a legitimate reason can lead to denial of stay-related permissions such as extension. KARXY should check age, application type, refusal reason, prior registration history, and competent-office guidance.",
    },
    source: "출입국관리법 제38조",
  },
  {
  ...
  },
  {
    ...
    content: {
      ko: "출입국관리법 제60조는 강제퇴거명령에 대한 이의신청 절차를 정합니다. 강제퇴거명령서를 받은 사람은 받은 날부터 7일 이내 지방출입국·외국인관서의 장을 거쳐 법무부장관에게 이의신청서를 제출해야 합니다. 관서장은 심사결정서와 조사기록을 첨부해 제출하고, 법무부장관의 결정에 따라 이유 있으면 지체 없이 통지하고 보호 중인 경우 보호를 해제해야 합니다. KARXY는 강제퇴거 상담에서 통지서 수령일, 7일 기한, 송달 방식, 보호 여부, 조사기록·소명자료, 별도 행정소송·집행정지 검토 필요성을 즉시 확인해야 합니다.",
      vi: "Điều 60 Luật Quản lý xuất nhập cảnh quy định thủ tục khiếu nại đối với lệnh trục xuất. Người nhận lệnh phải nộp đơn khiếu nại cho Bộ trưởng Tư pháp thông qua cơ quan xuất nhập cảnh trong vòng 7 ngày kể từ ngày nhận lệnh. Cơ quan tiếp nhận gửi kèm quyết định thẩm tra và hồ sơ điều tra; nếu khiếu nại có căn cứ, người đang bị giữ phải được thông báo và được chấm dứt giữ theo quyết định. KARXY cần kiểm tra ngày nhận lệnh, thời hạn 7 ngày, cách tống đạt, tình trạng bị giữ, hồ sơ giải trình và khả năng cần kiện hành chính hoặc xin đình chỉ thi hành.",
      mn: "Цагаачлалын хуулийн 60 дугаар зүйл нь албадан гаргах тушаалд гомдол гаргах журмыг тогтоодог. Тушаал авсан хүн авсан өдрөөс 7 хоногийн дотор орон нутгийн цагаачлалын байгууллагаар дамжуулан Хууль зүйн сайдад гомдол гаргах ёстой. Байгууллага шалгалтын шийдвэр, мөрдөн шалгах материалыг хавсаргана; гомдол үндэслэлтэй бол мэдэгдэж, хамгаалалтад байгаа бол суллах ёстой. KARXY тушаал авсан өдөр, 7 хоногийн хугацаа, хүргүүлсэн хэлбэр, хамгаалалт, тайлбар нотолгоо, захиргааны маргаан/гүйцэтгэл зогсоох боломжийг шалгана.",
      en: "Immigration Act Article 60 sets the objection procedure for a deportation order. A person who receives a deportation order must submit an objection to the Minister of Justice through the head of the local immigration office within seven days from receipt. The office forwards the review decision and investigation records, and if the objection is found to have grounds, the person must be notified and released if under detention or protection. KARXY should immediately check receipt date, the seven-day deadline, service method, detention status, supporting records, and whether separate administrative litigation or stay of execution needs professional review.",
    },
    source: "출입국관리법 제60조",
  },
  {
    ...
    content: {
      ko: "출입국관리법 제63조는 강제퇴거명령 후 보호소 또는 보호시설에 얼마나 보호될 수 있는지, 즉 즉시 송환할 수 없는 경우의 보호기간과 연장 한계를 정합니다. 여권이 없거나 교통편이 확보되지 않는 등 사유가 있으면 2개월 범위에서 송환할 수 있을 때까지 보호시설에 보호할 수 있고, 2개월 후에도 송환할 수 없으면 외국인보호위원회 승인으로 매 3개월 범위에서 연장할 수 있습니다. 총 보호기간은 원칙적으로 9개월을 넘을 수 없지만, 난민신청·소송으로 송환 절차가 지연되거나 중대한 범죄 사유가 있으면 20개월 한계가 문제될 수 있습니다. KARXY는 보호 상담에서 강제퇴거명령일, 보호 개시일, 여권·항공편 확보 여부, 송환 협조 여부, 난민·소송 진행, 보호기간 연장 승인 여부를 확인해야 합니다.",
      vi: "Điều 63 Luật Quản lý xuất nhập cảnh quy định việc giữ người đã nhận lệnh trục xuất khi chưa thể đưa họ ra khỏi Hàn Quốc ngay. Nếu không có hộ chiếu, chưa có phương tiện vận chuyển hoặc có lý do tương tự, người đó có thể bị giữ tại cơ sở bảo hộ trong phạm vi 2 tháng cho đến khi có thể hồi hương; sau 2 tháng, việc gia hạn từng đợt tối đa 3 tháng cần phê chuẩn của Ủy ban bảo hộ người nước ngoài. Tổng thời gian giữ theo nguyên tắc không quá 9 tháng, nhưng có thể phát sinh giới hạn 20 tháng trong trường hợp thủ tục hồi hương bị trì hoãn do xin tị nạn/kiện tụng hoặc một số tội nghiêm trọng. KARXY phải kiểm tra ngày lệnh, ngày bắt đầu giữ, hộ chiếu/chuyến bay, hợp tác hồi hương, tị nạn/kiện tụng và phê chuẩn gia hạn.",
      mn: "Цагаачлалын хуулийн 63 дугаар зүйл нь албадан гаргах тушаал авсан хүнийг шууд буцаах боломжгүй үед хамгаалах журмыг тогтоодог. Паспортгүй, тээврийн хэрэгсэлгүй зэрэг шалтгаан байвал буцаах хүртэл 2 сарын хүрээнд хамгаалах байгууламжид байлгаж болно; 2 сарын дараа ч буцаах боломжгүй бол Гадаад иргэний хамгаалах зөвлөлийн зөвшөөрлөөр 3 сарын хүрээнд сунгана. Нийт хугацаа зарчмаар 9 сараас хэтрэхгүй боловч дүрвэгчийн хүсэлт/шүүх маргаан эсвэл ноцтой гэмт хэрэгтэй бол 20 сарын хязгаар асуудал болно. KARXY тушаалын өдөр, хамгаалах эхэлсэн өдөр, паспорт/нислэг, хамтран ажилласан эсэх, дүрвэгч/шүүх ажиллагаа, сунгалтын зөвшөөрлийг шалгана.",
      en: "Immigration Act Article 63 governs protection or detention after a deportation order when immediate repatriation is not possible. If the person lacks a passport, transportation is unavailable, or similar grounds exist, the person may be held in a protection facility for up to two months until repatriation becomes possible. If repatriation remains impossible after two months, extensions of up to three months at a time require prior approval from the Foreigners' Protection Committee. The total period is generally capped at nine months, but a twenty-month cap may arise where repatriation is delayed by refugee applications or litigation, or specified serious-crime grounds. KARXY should check the deportation-order date, protection start date, passport and flight availability, cooperation with repatriation, refugee or litigation status, and extension approvals.",
    },
    source: "출입국관리법 제63조",
  },
  {
  ...
  },
  {
    ...
    content: {
      ko: "외국인은 허가된 체류자격과 활동범위를 벗어나 취업하거나 활동하면 체류자격 위반 문제가 발생할 수 있습니다. 취업활동은 취업 가능한 체류자격 또는 별도 허가 구조를 먼저 확인해야 하며, D-2/D-4 유학생의 시간제취업도 허가·신고 요건을 별도로 봐야 합니다. 허위서류, 허위초청, 무허가 취업, 체류기간 도과 등은 사안에 따라 강제퇴거, 입국금지, 형사처벌 또는 과태료·범칙금으로 이어질 수 있으므로 KARXY는 불법 요청을 거절하고 합법 준비 경로만 안내합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "하이코리아는 체류자격별 통합 안내 매뉴얼을 통해 사증 및 체류 민원의 신청대상과 필요서류를 안내합니다. 이 매뉴얼은 지침 변경 시 수정되지만 업로드에 시간이 걸릴 수 있으므로, 최신 지침에 따른 정확한 상담은 1345 또는 방문예약 후 관할 출입국외국인관서 확인이 필요합니다. KARXY는 D-2, D-4, D-10, E-7, F-2, F-5 질의에서 출입국관리법·시행령·시행규칙 근거를 먼저 확인하고, 이 문서는 운영 서류·절차 보조 근거로 사용합니다.",
      ...
      mn: "HiKorea нь виз болон оршин суух өргөдлийн ангилал бүрийн хамрах хүрээ, бүрдүүлэх материалыг нэгдсэн гарын авлагаар тайлбарладаг. Журам өөрчлөгдвөл шинэчилдэг боловч нийтлэх хугацаа хоцорч болох тул 1345 эсвэл харьяа цагаачлалын байгууллагаар баталгаажуулах шаардлагатай. KARXY нь эхлээд хууль, хэрэгжүүлэх журам, дүрмийг шалгаж, энэ эх сурвалжийг ажиллагааны туслах үндэслэл болгон ашиглана.",
  ...
  },
  {
    ...
    content: {
      ko: "현재 체류자격을 유지하면서 다른 체류자격에 해당하는 활동을 병행하려면 사전에 체류자격외활동허가를 받아야 합니다. 하이코리아 전자민원에는 유학생(D-2) 및 어학연수생(D-4-1) 시간제취업 허가/신고 메뉴가 별도로 제공됩니다. 병행 활동이 전일 근무 등 주된 활동이 되는 경우 체류자격외활동이 아니라 출국 후 새 사증 또는 체류자격변경 검토 대상입니다. KARXY는 취업 매칭을 하지 않고 허가 필요 여부만 안내합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "하이코리아 민원서식 목록에는 통합신청서(신고서), 신원보증서, 유학생현황, 어학연수생현황, 외국인유학(어학연수)생 시간제취업 확인서 등 체류 민원에 쓰이는 양식이 제공됩니다. KARXY의 서류 체크리스트는 이 서식 목록과 체류자격별 매뉴얼을 함께 근거로 삼아야 하며, 사용자에게는 원본/사본, 번역, 공증, 아포스티유 또는 영사확인 필요 여부를 별도 확인하도록 안내합니다.",
      vi: "Danh mục biểu mẫu HiKorea cung cấp các mẫu dùng cho lưu trú như đơn tổng hợp, giấy bảo lãnh, danh sách du học sinh/học tiếng và xác nhận làm thêm của du học sinh. Checklist của KARXY phải kết hợp danh mục biểu mẫu này với sổ tay theo từng tư cách lưu trú, đồng thời yêu cầu kiểm tra bản gốc/bản sao, dịch thuật, công chứng, apostille hoặc xác nhận lãnh sự.",
      mn: "HiKorea-ийн маягтын жагсаалтад нэгдсэн өргөдөл/мэдэгдэл, батлан даалтын бичиг, оюутан/хэлний суралцагчийн жагсаалт, оюутны цагийн ажлын баталгааны маягт зэрэг орно. KARXY-ийн материалын жагсаалт энэ маягт болон ангиллын гарын авлагыг хамтад нь ашиглаж, эх хувь/хуулбар, орчуулга, нотариат, апостиль эсвэл консулын баталгааг тусад нь шалгуулна.",
      en: "HiKorea's forms list provides stay-petition forms such as the integrated application/report form, letter of guarantee, international student and language trainee lists, and student part-time work confirmation. KARXY document checklists should combine this forms list with the status-specific manual and ask users to separately verify original/copy, translation, notarization, apostille, or consular confirmation needs.",
    },
    source: "HiKorea · 민원서식",
  },
  {
  ...
  },
  {
    ...
    content: {
      ko: "하이코리아 공지사항에는 체류·사증 관리 매뉴얼, 전자팩스 신고대상 변경, 특정 제도 시행 등 정책 변경성 문서가 게시됩니다. KARXY 자동 크롤링은 공지 제목·첨부파일·게시일의 diff 감지만 수행하고, production RAG 반영은 관리자 승인 후에만 해야 합니다. 예를 들어 육성형 전문기술인력 제도처럼 D-10·E-7 계열에 영향을 줄 수 있는 문서는 관련 compliance rule과 기존 사용자 질의 로그의 영향 목록을 산출해야 합니다.",
      vi: "Thông báo HiKorea có thể chứa tài liệu thay đổi chính sách như sổ tay quản lý visa/lưu trú, thay đổi kênh fax điện tử hoặc chế độ mới. Crawler của KARXY chỉ nên phát hiện diff về tiêu đề, tệp đính kèm và ngày đăng; chỉ đưa vào production RAG sau khi admin phê duyệt. Tài liệu có thể ảnh hưởng D-10/E-7 phải sinh danh sách rule và người dùng bị ảnh hưởng.",
      mn: "HiKorea мэдэгдэлд виз/оршин суух удирдлагын гарын авлага, цахим факсын өөрчлөлт, шинэ тогтолцооны хэрэгжилт зэрэг бодлогын өөрчлөлт нийтлэгдэж болно. KARXY автомат crawler нь зөвхөн гарчиг, хавсралт, нийтэлсэн огнооны ялгааг илрүүлж, production RAG-д зөвхөн админ баталсны дараа оруулна. D-10/E-7-д нөлөөлөх баримт нь rule болон хэрэглэгчийн нөлөөллийн жагсаалт гаргана.",
      en: "HiKorea notices can publish policy-changing documents such as visa/stay management manuals, e-fax filing changes, and new program rollouts. KARXY automation should only detect diffs in notice title, attachment, and posted date; production RAG updates require admin approval. Documents that may affect D-10 or E-7, such as skill-development professional workforce manuals, should produce impacted compliance-rule and user-query lists.",
    },
    source: "HiKorea · 공지사항",
  },
  {
    ...
    content: {
      ko: "하이코리아 첫 화면은 공지사항 목록보다 빠르게 사칭사이트 주의, 전자팩스 신고대상 변경, 전자민원·방문예약 운영 안내 같은 실무 변경을 노출할 수 있습니다. KARXY는 공지 게시판뿐 아니라 첫 화면의 긴급 배너와 주요 링크도 매일 감시합니다. 이런 변경은 법령 자체는 아니지만 접수 방식, 제출 채널, 사용자 안전 안내에 직접 영향을 주므로 PENDING 후보와 운영 알림으로 분리해 검수합니다.",
      vi: "Trang chính HiKorea có thể hiển thị cảnh báo giả mạo, thay đổi đối tượng khai báo e-fax, hoặc hướng dẫn vận hành e-application/đặt lịch trước danh sách thông báo. KARXY theo dõi cả banner khẩn và liên kết chính hằng ngày. Các thay đổi này không phải luật nhưng ảnh hưởng trực tiếp đến cách nộp, kênh nộp và an toàn người dùng.",
      mn: "HiKorea нүүр хуудас нь хуурамч сайт, цахим факс, цахим өргөдөл/цаг захиалгын ажиллагааны мэдэгдлийг зарын жагсаалтаас түрүүлж харуулж болно. KARXY нь яаралтай баннер болон гол холбоосыг өдөр бүр хянадаг. Энэ нь хууль биш боловч мэдүүлэх арга, суваг, хэрэглэгчийн аюулгүй байдалд шууд нөлөөлнө.",
      en: "The HiKorea homepage can expose practical changes such as scam-site warnings, e-fax filing changes, or e-application/visit-reservation operation notices before users find them in the notice list. KARXY monitors homepage urgent banners and main links daily. These are not statutes, but they affect filing channels and user-safety guidance, so they become PENDING candidates and operations alerts.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "법무부 출입국·외국인정책본부 주요소식은 하이코리아 매뉴얼보다 먼저 제도 도입, 시행기간, 대상 변경, 외국인 정책 방향을 공지할 수 있습니다. KARXY는 주요소식을 매일 감시하되, 사용자에게 곧바로 확정 요건처럼 안내하지 않습니다. 법령·시행령·시행규칙에 근거가 있는지 확인하고, 운영 지침으로 확정되기 전에는 '정책 공지 단계'로 표시해 행정사 검토를 요구합니다.",
      vi: "Tin chính của Cục xuất nhập cảnh Bộ Tư pháp có thể công bố chương trình, thời hạn áp dụng, thay đổi đối tượng hoặc định hướng chính sách trước khi sổ tay HiKorea cập nhật. KARXY theo dõi hằng ngày nhưng không trình bày ngay như điều kiện đã chốt; cần kiểm tra căn cứ luật/nghị định/quy tắc và đánh dấu là giai đoạn thông báo chính sách cho đến khi có hướng dẫn vận hành.",
      mn: "Хууль зүйн яамны цагаачлалын гол мэдээ нь HiKorea гарын авлагаас өмнө шинэ тогтолцоо, хэрэгжих хугацаа, хамрах хүрээ, бодлогын чиглэлийг зарлаж болно. KARXY өдөр бүр хянах боловч шууд батлагдсан шаардлага мэт хариулахгүй; хууль, журам, дүрмийн үндэслэл болон үйл ажиллагааны зааврыг шалгана.",
      en: "MOJ immigration policy news may announce programs, effective periods, target changes, or policy direction before HiKorea manuals are updated. KARXY monitors it daily but does not treat it as a finalized filing requirement until the statutory/regulatory basis and operational guidance are confirmed. Until then, responses should mark it as a policy-notice stage and require administrative-scrivener review.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "법무부 공지사항에는 2025-12-29 작성일로 '2026년 특정활동(E-7) 체류자격 임금요건 기준 공고'가 게시되어 있고, 문서에는 [법무부 공고 2025-406호] 및 첨부 PDF가 표시됩니다. 이 문서는 E-7 채용·체류자격 변경·연장 상담에서 임금요건을 확인해야 하는 공식 운영 근거입니다. 다만 실제 적용 금액, 직종별 예외, 경과규정은 첨부 원문과 최신 하이코리아/관할관서 지침까지 대조해야 하므로, KARXY 답변은 원문 공고와 확인일을 제시하고 개별 사건은 행정사 검토로 넘겨야 합니다.",
  ...
  },
  {
    ...
    content: {
      ko: "법무부 공지사항에는 2026-01-08 작성일의 '재외동포(F-4) 자격의 취업활동 제한범위 고시' 행정예고가 게시되어 있으며, 법무부 공고 제2026-2호와 2026-01-09 기준 문구가 표시됩니다. 행정예고는 확정 고시 전 의견수렴 단계일 수 있으므로, KARXY는 이를 F-4 취업 가능 여부의 최종 결론으로 답하지 않습니다. 다만 F-4 상담에서 직종 제한, 위반 위험, 변경 가능성을 안내하고 확정 고시 여부를 추가 확인해야 하는 경고 출처로 사용합니다.",
      vi: "Thông báo Bộ Tư pháp ngày 2026-01-08 về phạm vi hạn chế hoạt động việc làm của tư cách F-4 là giai đoạn dự thảo/tham vấn, có Công báo số 2026-2 và ngày 2026-01-09. KARXY không dùng nó như kết luận cuối cùng về việc F-4 có được làm nghề cụ thể hay không; chỉ dùng làm cảnh báo cần kiểm tra quyết định cuối cùng.",
      mn: "2026-01-08-ний мэдэгдэлд F-4 ангиллын ажил эрхлэлтийн хязгаарын захиргааны урьдчилсан мэдэгдэл, 2026-2 дугаар албан мэдэгдэл нийтлэгдсэн. Энэ нь эцсийн журам гарахаас өмнөх санал авах шат байж болох тул KARXY F-4 ажиллах эрхийн эцсийн дүгнэлт болгон ашиглахгүй. Харин ажил мэргэжлийн хязгаар, эрсдэл, өөрчлөлтийг шалгах анхааруулга болгон хэрэглэнэ.",
      en: "The MOJ notice dated 2026-01-08 is an administrative preannouncement on the employment-restriction scope for Overseas Korean (F-4) status, showing MOJ Public Notice 2026-2 and a 2026-01-09 notice date. A preannouncement may be a consultation stage before a final notice, so KARXY must not answer it as the final rule for whether an F-4 holder may work in a job. It is used as a warning source to check job restrictions, violation risk, and whether the final notice has been issued.",
    },
  ...
  },
  {
    ...
    content: {
      ...
      en: "The MOJ 2025-02-18 e-Arrival implementation notice states that the system starts on 2025-02-24, paper arrival cards can be used in parallel until December 2025, there is no fee, there is no separate approval process, and travelers do not need to carry a PDF or printout at entry. Submission requires passport, flight or ship, Korean address, and email information, and the entered data can be modified before immigration inspection. KARXY should check K-ETA status, registered-foreigner status, group size, arrival date, and submission timing together.",
    },
  ...
  },
  {
    ...
    content: {
      ...
      en: "The MOJ office-jurisdiction page is the official source for immigration-office jurisdiction, address, phone number, and service scope in Seoul, Incheon, and Gyeonggi. Before advising on alien registration, extension, status change, address reporting, or visit reservation, KARXY must check the competent office by residence, workplace, and petition type. As checked on 2026-07-03, the Seoul office lists districts including Gangnam, Songpa, Seocho, Yongsan, and the cities of Seongnam, Hanam, and Gwacheon; Sejongno and Seoul Southern list separate district groups. Incheon, Suwon, Yangju, Ansan, Goyang, and Gimpo Airport have regional and service-scope splits, so the original page and 1345 should be checked before filing.",
    },
  ...
  },
  {
    ...
    content: {
      ko: "브로커 위험 신호: 1) 비용을 항목별로 설명하지 않고 총액만 말함. 2) 비자 100% 보장 약속. 3) 허위 잔고증명·허위 서류 제공 제안. 4) 불법취업 알선. 5) 계약서 없이 현금만 요구. 6) 학교 직원인 척 하며 특정 학교 강요. 7) 비용이 공식 예상보다 30% 이상 높음. 8) SNS·지인 통한 사적 연락만. 이런 신호가 있으면 KARXY 비용 계산기로 항목별 비교 후 행정사 상담을 권장합니다.",
      vi: "Dấu hiệu môi giới rủi ro: 1) Chỉ báo tổng, không rõ từng mục. 2) Bảo đảm 100% visa. 3) Đề nghị sổ giả. 4) Giới thiệu việc bất hợp pháp. 5) Tiền mặt, không hợp đồng. 6) Ép chọn trường. 7) Cao hơn 30% thực tế. 8) Liên lạc qua SNS. Nếu thấy → so sánh phí + gặp chuyên gia hành chính.",
      ...
      en: "Broker red flags: 1) Total only, no itemization. 2) 100% visa guarantee. 3) Offers fake docs. 4) Illegal job matching. 5) Cash only, no contract. 6) Forces specific school, pretends school staff. 7) 30%+ over official estimate. 8) Private SNS contact only. → Compare items, consult an administrative scrivener.",
    },
    source: "KARXY 안전 가이드라인",
  },
];

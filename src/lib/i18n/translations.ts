...
export const t = {
  ...
  quick_diagnosis_eyebrow: { ko: "빠른 경로 찾기", vi: "Tìm lộ trình nhanh", mn: "Хурдан маршрут", en: "Quick path finder" },
  quick_diagnosis_title: { ko: "지금 상황에 가까운 항목을 골라보세요", vi: "Chọn tình huống gần với bạn nhất", mn: "Өөрийн нөхцөлд хамгийн ойрыг сонгоно уу", en: "Choose the option closest to your situation" },
  quick_diagnosis_subtitle: { ko: "한 번 선택하면 추천 경로와 예상 준비비를 바로 보여드려요.", vi: "Chọn một lần để xem ngay lộ trình và chi phí dự kiến.", mn: "Нэгийг сонгоод санал болгох маршрут, зардлыг шууд харна уу.", en: "Choose once to see a suggested path and estimated cost immediately." },
  ...
  quick_option_language_desc: { ko: "어학당·D-4 준비", vi: "Trường tiếng · D-4", mn: "Хэлний курс · D-4", en: "Language program · D-4" },
  ...
  quick_option_degree_desc: { ko: "전문대·대학교·D-2 준비", vi: "Cao đẳng·Đại học · D-2", mn: "Коллеж·Их сургууль · D-2", en: "College or university · D-2" },
  ...
  quick_option_transfer_desc: { ko: "학력 연결·D-2 준비", vi: "Liên thông học lực · D-2", mn: "Боловсролын шилжилт · D-2", en: "Academic progression · D-2" },
  ...
  quick_result_summary: { ko: "현재 선택 기준으로 {visa} 준비가 가장 가까워요.", vi: "Theo lựa chọn hiện tại, lộ trình {visa} phù hợp nhất.", mn: "Одоогийн сонголтоор {visa} маршрут хамгийн ойр байна.", en: "Based on this choice, the {visa} path is the closest fit." },
  ...
  quick_result_note: { ko: "대표 조건 기준의 빠른 결과이며, 국적·나이·예산에 따라 달라질 수 있어요.", vi: "Kết quả nhanh dựa trên điều kiện mẫu; có thể thay đổi theo quốc tịch, tuổi và ngân sách.", mn: "Жишиг нөхцөлд суурилсан хурдан үр дүн бөгөөд иргэншил, нас, төсвөөс хамаарч өөрчлөгдөнө.", en: "This quick result uses representative assumptions and may change with nationality, age, and budget." },

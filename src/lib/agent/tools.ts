...
import { DIAGNOSIS_GOALS } from "@/lib/data/diagnosis";
...
const diagnosePathTool: Tool = {
  ...
  parameters: {
    ...
    properties: {
      ...
      goal: { type: "string", description: "유학 목표", enum: [...DIAGNOSIS_GOALS] },
  ...
  execute: async (args) => {
    ...
    const goal = enumArg(args, "goal", DIAGNOSIS_GOALS, "unsure");
